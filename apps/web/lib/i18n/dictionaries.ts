export const en = {
  ...
  "activity.search.title": "Find a tend",
  "activity.search.to": "To",
  "activity.search.type": "Type",
  "activity.search.typeAll": "All types",
  "activity.subtitle": "What you marked tended, in order. Correct a date if you need to.",
  ...
  "checkIn.note.quiet": "This stretch can stay light. One tend is enough when there is room.",
  "checkIn.note.steady": "You came back to a few things. Keep the pace that feels kind.",
  "checkIn.openActivity": "History",
  "checkIn.openActivity.hint": "Browse tended dates, or fix one if it was logged wrong.",
  ...
  "checkIn.subtitle": "What you came back to, and on which days.",
  ...
  "email.passwordReset.preheader": "Choose a new password. This link expires in one hour.",
  "email.passwordReset.subject": "Reset your Tend password",
  "errors.activity.delete": "Could not remove this event. Please try again.",
  "errors.activity.load": "Could not load history. Please try again.",
  ...
  "landing.eyebrow": "Everyday care, without turning it into a chore.",
  ...
  "promo.activity.alt": "Tend history showing tended dates without scores or streaks",
  "promo.activity.description":
    "History lists what you marked tended, without turning it into a score.",
  "promo.activity.title": "What you tended, written down.",
  ...
  "items.add.subtitle": "Give it a name and a rhythm. Tend will remember.",
  ...
  "items.detail.recentEvents.title": "Tended dates",
  "items.detail.subtitle": "Rhythm, status, and the dates you marked tended.",
  ...
  "items.lastActivityPrefix": "Last tended",
  ...
  "reflections.subtitle": "Write today's page. Earlier days are in the month below.",
...
export const sr = {
  ...
  "activity.search.title": "Pronađi tend",
  "activity.search.to": "Do",
  "activity.search.type": "Tip",
  "activity.search.typeAll": "Svi tipovi",
  "activity.subtitle": "Ono što si označio/la kao pobrinuto, redom. Ispravi datum ako treba.",
  "activity.title": "Istorija",
  ...
  "checkIn.note.quiet": "Ovaj period može ostati lagan. Jedan tend je dovoljan kad imaš prostora.",
  "checkIn.note.steady": "Vratio/la si se na nekoliko stvari. Zadrži ritam koji ti prija.",
  "checkIn.openActivity": "Istorija",
  "checkIn.openActivity.hint":
    "Pregledaj datume posvećenosti, ili ispravi ako je nešto zabeleženo pogrešno.",
  ...
  "checkIn.subtitle": "Čemu si se vratio/la, i koj dana.",
  ...
  "email.passwordReset.preheader": "Izaberi novu lozinku. Ovaj link važi jedan sat.",
  "email.passwordReset.subject": "Resetuj Tend lozinku",
  "errors.activity.delete": "Nije moguće ukloniti ovaj događaj. Pokušaj ponovo.",
  "errors.activity.load": "Nije moguće učitati istoriju. Pokušaj ponovo.",
  ...
  "landing.eyebrow": "Svakodnevna briga, bez pretvaranja u obavezu.",
  "landing.feature.friend.body":
  ...
  "promo.activity.alt": "Tend istorija sa datumima posvećenosti, bez poena i nizova",
  "promo.activity.description":
    "Istorija nabraja šta si označio/la kao pobrinuto, bez pretvaranja u rezultat.",
  "promo.activity.title": "Ono što si tendovao/la, zapisano.",
  ...
  "items.add.subtitle": "Daj mu ime i ritam. Tend će da pamti.",
  ...
  "items.detail.noEvents": "Još uvek nema zabeleženog tendovanja za ovu stavku.",
  "items.detail.recentEvents.description": "Ispravi datume ako je nešto pogrešno zabeleženo.",
  "items.detail.recentEvents.title": "Datumi posvećenosti",
  "items.detail.subtitle": "Ritam, status i datumi koje si označio/la kao pobrinute.",
  ...
  "items.lastActivityPrefix": "Poslednji put pobrinuto",
  ...
  "reflections.subtitle": "Napiši današnju stranicu. Raniji dani su u mesecu ispod.",
